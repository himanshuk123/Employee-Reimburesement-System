...
<body>
    <nav   class="navbar nav-pills navbar-expand-md">
        ...
        <a class="nav-link active" href="EmployeeUpdatejsp.jsp">Update Details</a>
    ...
    <section >
            <div class="col-md-6" >
                    <form method="post" action="http://localhost:8080/ERSSystem/UpdateEmpProfile" class="form" >
                ...
                required="required"></span>
                        ...
                        <div class="form-group">
                            ...
                            <span><input name="empdob" type="text" class="form-control" placeholder="type your DateOfBirth here *"
                required="required" ></span>  
                
                <div class="form-group">
                            <span><label class="control-label">Contact No.</label></span>
                            <span><input name="empphoneno" type="number" class="form-control" placeholder="type your Contact here *"
                required="required" ></span>
                
                <div class="form-group">
                            <span><label class="control-label">Gender</label></span>
                            <span><input name="empgender" type="text" class="form-control" placeholder="Mention Gender *"
                required="required" ></span>
                ...
                required="required" ></span>
                       ...
                       <span><button class="btn">Update Profile</button></span>
                    </form>
                </div>      
