...
public class AllAcceptedReim extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<ReimEntity> elist= reimservice.allacceptedreim();
		
		PrintWriter out = response.getWriter();
		out.println("<div style=  ' background-color:  #ADD8E6;'>");
		out.println("<table width=200 height=200 border=1>");           
		out.println("<caption> ***************All Accepted Reimbursement*************** </caption>");
		out.println("<br>");
